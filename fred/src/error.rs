...
use fred_types::types::RedisTypeError;
...
impl From<RedisTypeError> for RedisError {
    fn from(value: RedisTypeError) -> Self {
        RedisError::new(RedisErrorKind::Unknown, value.0)
    }
}
